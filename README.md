...
**Author:** Julie Jin (UGrad)  
**Course:** C142 Machine Learning, Statistical Models, and Optimization for Molecular Problems
...
| **3 (best)** | **384→256→128→1** | **1e-3** | **20** | **0** | **8192** | **0.0** | **1.24** | **1.25** | **1.24** |
...
<sup>1</sup> Smith, J. S., Isayev, O., & Roitberg, A. E. (2017). ANI-1: an extensible neural network potential with DFT accuracy at force field computational cost. *Chemical Science*, 8(4), 3192–3203.
 
<sup>2</sup> Behler, J., & Parrinello, M. (2007). Generalized neural-network representation of high-dimensional potential-energy surfaces. *Physical Review Letters*, 98(14), 146401.
 
<sup>3</sup> Paszke, A., et al. (2019). PyTorch: An imperative style, high-performance deep learning library. *Advances in Neural Information Processing Systems*, 32.
 
<sup>4</sup> Gao, X., et al. (2020). TorchANI: A free and open source PyTorch-based deep learning implementation of the ANI neural network potentials. *Journal of Chemical Information and Modeling*, 60(7), 3408–3415.
